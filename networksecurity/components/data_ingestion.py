...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            logging.info(f"Downloaded {df.shape[0]} records from MongoDB")
            ...
            logging.info("Converted MongoDB collection to dataframe")
    ...
    def export_data_into_feature_store(self, dataframe: pd.DataFrame):
        """
        Save dataframe into feature store
        """
        try:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        ...
        try:
            ...
            logging.info(f"Train dataset saved at {train_file_path}")
            logging.info(f"Test dataset saved at {test_file_path}")
